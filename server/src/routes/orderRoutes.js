...
router.post("/public/:orderId/cancel", asyncHandler(customerCancelOrder));
...
router.patch("/kitchen/:orderId/cancel", asyncHandler(staffCancelOrder));
router.get("/", asyncHandler(getOrders));
router.get("/:orderId", asyncHandler(getOrder));
router.patch("/:orderId/cancel", asyncHandler(staffCancelOrder));
